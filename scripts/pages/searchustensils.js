  ...
  btnsArray.forEach ((item, index) => {
    ...
    item.addEventListener ('click', function () {
      ...
      listContentArray.forEach ((list, index) => {
        ...
        let todolistContent = document.querySelectorAll (
          '.card__header__todolist__content'
        );
...
const icon = document.querySelector (
  '.card__header__naving__columnThree__header__title'
);
const activeDisplay = document.querySelector (
  '.card__header__naving__columnThree__header__modal'
);
const iconup = document.querySelector (
  '.card__header__naving__columnThree__header__title__img'
);
...
export function reqInputUstensil (vCardData) {
  ...
  inputUstensils.addEventListener ('input', event => {
    ...
    if (dataInput) {
      console.log (
        "insertion d'un élément dans la recherche(input) des ustensils"
      );
